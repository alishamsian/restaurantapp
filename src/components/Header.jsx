        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center justify-center gap-3 cursor-pointer bg-gray-200 hover:bg-gray-300 transition-all duration-100 ease-out text-textColor text-base "
                onClick={logout}
              >
                Logout <MdLogout />
              </p>
